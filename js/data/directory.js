...
export const PLANNING = [
  ...
  { id:'gmwss', name:'GMWSS Board of Commissioners', phone:'502-863-9800', icon:'💧', icoc:'di-t', group:'regional',
    ...
    members:[
      ...
      { name:'Jeff Klocke', ini:'JK', av:'av-t', title:'Commissioner (Treasurer)', tags:['t-board','t-regional'], ph:'502-863-9800', f:'updated',
        notes:'Reappointment resolved Dec 8 2025. Listed as Treasurer in Jan 2026 GMWSS board packet (gmwss.com).',
        bio:'Jeff Klocke serves as Treasurer on the GMWSS Board of Commissioners. His reappointment was tabled at the November 24, 2025 council meeting — the first application of Hampton\'s new resume-review process — and resolved at the December 8, 2025 meeting.',
        positionSummary:'GMWSS Board Treasurer. Oversees Georgetown\'s water and sewer utility under KRS 96.320.', socials:[], events:[
          { date:'Dec 8 2025', text:'Reappointment resolved at December 8 meeting. Confirmed as GMWSS Treasurer in Jan 2026 board packet.', url:'https://www.georgetownky.gov/AgendaCenter', summary:'Jeff Klocke\'s GMWSS reappointment — tabled from November 24 under Hampton\'s resume-review reform — was resolved at the December 8 council meeting. The GMWSS board packet for January 27, 2026 confirms Klocke serving as Treasurer. Per-member vote breakdown pending official Dec 8 minutes.' },
          { date:'Nov 24 2025', text:'Reappointment tabled to Dec 8 — motion by Tingle Sames.', url:'https://www.georgetownky.gov/AgendaCenter/ViewFile/Minutes/_11242025-293', summary:'Jeff Klocke\'s GMWSS reappointment was tabled from November 24 to December 8 via a subsidiary motion by Councilmember Tingle Sames (seconded by Wilkins Brent). This was one of the first applications of Hampton\'s newly passed transparency reform requiring candidates to provide resumes and service history before a vote.' },
        ], stats:[] },
      { name:'Greg Gibson', ini:'GG', av:'av-t', title:'Commissioner', tags:['t-board','t-regional'], ph:'502-863-9800', f:'new',
        notes:'Appointed Dec 22 2025 (unanimous). Councilmember Stone endorsed — worked with Gibson in police dept., noted military background.',
        bio:'Greg Gibson was appointed to the GMWSS Board of Commissioners on December 22, 2025, one of seven unanimous first-time board appointments made at that meeting.',
        positionSummary:'GMWSS Board Commissioner. Oversees Georgetown\'s water and sewer utility under KRS 96.320.', socials:[], events:[
          { date:'Dec 22 2025', text:'Appointed to GMWSS Board — one of seven unanimous first-time appointments.', url:'https://www.georgetownky.gov/AgendaCenter', summary:'Greg Gibson was unanimously appointed to the GMWSS Board at the December 22, 2025 city council meeting. Councilmember Stone noted his experience working with Gibson in the police department and praised his military background.' },
        ], stats:[] },
    ]},
